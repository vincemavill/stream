...
export default function Conference({navigation,route}) {
  // var defaultRoomName = 'dota2';
  // const webSocketUrl = 'wss://server.huvr.com:5443/WebRTCAppEE/websocket';
  ...
  publishStreamId = route.params.stream_id;
    ...
    callback(command: any, data: any) {
      ...
      switch (command) {
        ...
        case 'publish_started':
          ...
          adaptor.play(publishStreamId, undefined, roomId, []);
          setIsPlaying(true);
